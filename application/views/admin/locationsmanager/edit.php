    ...
    <div class="col-md-12">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo site_url('locationsmanager/edit/'.$results->id)?>" method="POST" class="form-horizontal" id="add-block-form">
                    <fieldset>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="title">Address</label>
                            <div class="col-md-6 col-sm-6">
                                <input type="text" class="form-control" name="location_add"  placeholder="Enter text" id="location_add" value="<?php echo $results->location_add; ?>"  />
                            </div>
                        </div>
                        <div class="form-group">
