...
<head>
    ...
    <link href="<?php echo base_url(); ?>includes/color/css/theme/default.css" rel="stylesheet" id="theme" />
    <!-- ================== END BASE CSS STYLE ================== -->
</head>
<body>
    <!-- begin #page-loader -->
    ...
    <div class="login-cover">
        <div class="login-cover-image"><img src="<?php echo base_url(); ?>includes/color/img/login-bg/bg-1.jpg" data-id="login-cover-image" alt="" /></div>
    ...
    <div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated flipInX">
            ...
            <div class="login-header">
                <div class="brand">
                    <!--span class="logo"></span--> <center><?php echo config_item('site_title'); ?></center>
                </div>
                <!--div class="icon">
            ...
            <div class="login-content">
                <form action="<?php echo base_url(); ?>login/signin" method="POST" class="margin-bottom-0">
        ...
        <ul class="login-bg-list">
            <li class="active"><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>includes/color/img/login-bg/bg-1.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>includes/color/img/login-bg/bg-2.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>includes/color/img/login-bg/bg-3.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>includes/color/img/login-bg/bg-4.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>includes/color/img/login-bg/bg-5.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>includes/color/img/login-bg/bg-6.jpg" alt="" /></a></li>
        </ul>
    ...
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="<?php echo base_url(); ?>includes/color/js/login-v2.demo.min.js"></script>
    <script src="<?php echo base_url(); ?>includes/color/js/apps.min.js"></script>
    <!-- ================== END PAGE LEVEL JS ================== -->
