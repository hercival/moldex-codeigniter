    ...
    <div class="col-md-12">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo site_url('categorymanager/edit/'.$results->id)?>" method="POST" class="form-horizontal" id="add-block-form">
                    <fieldset>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="title">Single Banner</label>
                            <div class="col-md-6 col-sm-6">
                                <?php $this->load->view('admin/media_btn', array('image_type' => 'proj_banner', 'current_image' => array('filename' => $results->proj_banner))); ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="text" class="form-control" name="orderby"  placeholder="Enter order" id="orderby" value="<?php echo $results->orderby; ?>"  />
                            </div>
                        </div>
                        <div class="form-group">
