   ...
   <div class="container-fluid bg-white">
    <div class="container">
        <div class="row project-details">
            <div class="col-sm-5 text-center"> <img src="<?php echo base_url();?>includes/uploads/<?php echo $com_data->logo; ?>">
                <br>
...
<div class="container-fluid project-nav-tabs">
    <div class="row">
        <ul class="nav nav-pills nav-justified">
            ...
            <li><a data-toggle="tab" href="#siteplan">SITE DEVELOPMENT PLAN</a></li>
            <li><a data-toggle="tab" href="#bldgfloorplan">BUILDINGS</a></li>
            <li><a data-toggle="tab" href="#amenities">AMENITIES & FEATURES</a></li>
            <?php if($com_data->project_type == 2){ ?><li><a data-toggle="tab" href="#housemodels">HOUSE MODELS</a></li><?php } ?>
        </ul>
    </div>
</div>
<div class="container-fluid bg-models">
    <div class="container tab-content">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        <input type="text" class="form-control" id="starting-point" placeholder="Starting Point"> </div>
                    <div class="col-md-1"><img src="<?php echo base_url();?>includes/img/circs.png"></div>
                    <div class="form-group col-md-4">
                        <input type="text" class="form-control" id="end-point" placeholder="<?php echo $com_data->project_name; ?>" disabled> </div>
                </div>
        ...
        <div class="row project-site-plan tab-pane fade" id="siteplan"> <img src="<?php echo base_url();?>includes/uploads/<?php echo $com_data->site_dev_plan; ?>" class="img-responsive"> </div>
        <div class="row project-bldg-fp tab-pane fade" id="bldgfloorplan"> <img src="<?php echo base_url();?>includes/uploads/<?php echo $com_data->floor_dev_plan; ?>" class="img-responsive">
<!--
            <div class="row margin-thumbnails">
               <?php //$floor_gallery = json_decode($com_data->floor_gallery);?>
                   <?php //if(count($floor_gallery) > 0){foreach($floor_gallery->item as $image){ ?>
                    <div class="col-xs-3">
...
-->
        ...
        <?php if($com_data->project_type == 2){ ?>
        ...
        <div class="row project-houseModel tab-pane fade" id="housemodels">
            <div class="row text-center tile-marginBottom">
               <?php foreach($housemodels as $models){ ?>
                    <div class="col-sm-12 col-md-4 project-tile margin-top10px-mobile">
                        <div id="housemodel1" style="background-image:url(<?php echo base_url();?>includes/uploads/<?php echo $models->tile;?>);"></div>
                        <!-- Determine if project is featured -->
                        <div id="<?php echo $models->status; ?>-tag"></div>
                        <!-- Determine if project is featured -->
                        <div class="project-tile-details">
                            <h3>
                                <a href="<?php echo base_url();?>projects/<?php echo $location_data->alias.'/'.$com_data->status.'/'.$project_type_alias->alias.'/'.$com_data->alias.'/'.$models->alias;?>"><?php echo $models->name; ?></a></h3>
                            ...
                            <a href="<?php echo base_url();?>projects/<?php echo $location_data->alias.'/'.$com_data->status.'/'.$project_type_alias->alias.'/'.$com_data->alias.'/'.$models->alias;?>" class="btn btn-primary btn-md">View Model</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
