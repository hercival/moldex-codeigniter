...
<html lang="en">
    ...
    <body>
        ...
        <!-- Carousel -->
        <?php module_position('home-banner',$page_details);?>
        <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <div class="fill" style="background-image:url(<?php echo base_url(); ?>includes/img/homeslide1.jpg)">
                    </div> 
                    <div class="home-caption">
                        <div class="container">
                            <div class="carousel-caption">
                               <h1>Your Home. Your Choice.</h1>
                               <p>We provide reliable and affordrable real estate products to uplift the Filipino lifestyle.</p>   
                               <br>
                               <a href="<?php echo base_url(); ?>" class="btn btn-primary btn-md">Learn More</a>                       
                            </div>
                        </div>                
                    </div>                       
                </div>
        ...
        <div class="container-fluid">
          <div class="row lease-tab">
            <div class="absolute-center">  
              <h2>Jumpstart your life with us!</h2>
              <p>Providing more than a roof over heads, Moldex homes offer quality living spaces that nurture life, relationships, and dreams.</p>
